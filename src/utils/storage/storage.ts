// FROM: https://github.com/jamal-rahimzadegan/tools/blob/master/src/modules/storage/storage.ts

type Keys = 'ReactJS' | 'JavaScript';
...
class Storage {
  ...
  get allItems(): MultipleItem | undefined {
    try {
      let items: MultipleItem = {};
